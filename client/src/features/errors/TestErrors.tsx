  ...
  return (
    <>
      ...
      <ButtonGroup variant="contained" sx={{ mt: 4 }}>
        <Button onClick={() => handleError("api/buggy/not-found")}>
          Not found
        </Button>
        <Button onClick={() => handleError("api/buggy/bad-request")}>
          Bad request
        </Button>
        <Button onClick={() => handleError("api/activities", "post")}>
          Validation error
        </Button>
        <Button onClick={() => handleError("api/buggy/server-error")}>
          Server error
        </Button>
        <Button onClick={() => handleError("api/buggy/unauthorised")}>
          Unauthorised
        </Button>
      </ButtonGroup>
